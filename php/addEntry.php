                        ...
                        <div class="">
                            ...
                            <form id="add_post_form" method="POST" enctype="multipart/form-data"
                                ...
                                <fieldset>
                                    ...
                                    <div class="signup-form-item">
                                        <div class=" fw-bold">
                                            <button class="createPostBtn"><input type="submit" name="new_post"
                                                    value="Submit" style=" background: 0;" class="fw-bold" /></button>
                                            <button class=" fw-bold createPostBtn"
                                                onclick="clear_button()">Clear</button>
                                        </div>
                                        <div class="login-form-item">
                                            <button class="createPostBtn"><a href="../myProfile.php"
